...
<div class="border-b border-primary-500 drop-shadow-2xl">
  ...
  <svelte:fragment slot="trail">
    <div class="flex justify-center items-center gap-1 md:gap-2">
      ...
      <a class="hidden sm:block gap-2 btn btn-sm variant-outline-surface rounded-full" href="https://sveltycms.com/marketplace">
